<template>
  <div class="bg-black">
    <div class="py-20 border-b border-white border-opacity-20">
      <p class="font-title text-2xl mb-12">A New Kind of Business</p>
    ...
    <div class="py-20 border-b border-white border-opacity-20">
      <div class="flex justify-center lg:justify-start">
        <p class="font-title text-2xl sm:text-3xl mb-12">Get Started in 3 Easy Steps</p>
      </div>
      <div class="flex flex-col md:flex-row justify-between items-center pt-20 sm:pt-40 pb-40 px-4">
        <img class="w-36 mb-20 md:0" src="~/assets/images/alien.png" alt="alien" />
        <div>
            <p class="font-title text-2xl mb-12">1. Register On Our Node Network</p>
            <p class="max-w-sm text-sm sm:text-base leading-8">
            With a combination of mobile technology, autonomous robots and
            partnerships with stores and restaurants, we make local delivery
            faster, smarter and more cost-efficient.
            </p>
        </div>
      </div>
      <div class="flex flex-col-reverse md:flex-row justify-between items-center by-40 px-4">
        <div>
            <p class="font-title text-2xl mb-12">2. Get Verified to User Our Network</p>
            <p class="max-w-sm text-sm sm:text-base leading-8">
            With a combination of mobile technology, autonomous robots and
            partnerships with stores and restaurants, we make local delivery
            faster, smarter and more cost-efficient.
        ...
        <img class="w-40 mb-20 md:0" src="~/assets/images/radar.png" alt="alien" />
      </div>
      <div class="flex flex-col md:flex-row justify-between items-center pt-40 px-4">
        <img class="w-48 mb-20 md:0" src="~/assets/images/ufo.png" alt="alien" />
        <div>
            <p class="font-title text-2xl mb-12">3. Start Delivering Like an UFO</p>
            <p class="max-w-sm text-sm sm:text-base leading-8">
            With a combination of mobile technology, autonomous robots and
            partnerships with stores and restaurants, we make local delivery
            faster, smarter and more cost-efficient.
    ...
    <div class="py-20 flex justify-center border-b border-white border-opacity-20">
      <p>Questions? Please e-mail: <a class="py-3 underline" href="mailto:questions@theopendrone.com">questions@theopendrone.com</a></p>
    </div>
    <div class="py-20">
