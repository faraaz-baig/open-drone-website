<template>
  <div>
    ...
    <div class=" flex flex-col justify-between md:flex-row py-12 border-b border-black border-opacity-20">
        ...
        <p class="max-w-lg leading-6 font-body text-sm md:font-base tracking-wider">We welcome comments and advices about the our steps at our company and our projects. Please email <a class="font-semibold mail" href="mailto:communityfeedback@theopendrone.com">communityfeedback@theopendrone.com</a> to share your advice. </p>
    </div>
    <div class="py-12">
